...
<form class="udp-form-filterbar" method="get" action="<?php echo esc_url( $action_url ); ?>" role="search">
    ...
    <div class="udp-form-filterbar__group">
        ...
        <select id="udp-filter-facultad" name="udp_facultad" class="udp-form-select udp-form-select--slim" data-udp-autosubmit>
    ...
    <div class="udp-form-filterbar__group">
        ...
        <select id="udp-filter-year" name="udp_year" class="udp-form-select udp-form-select--slim" data-udp-autosubmit>
    ...
    <div class="udp-form-filterbar__group udp-form-filterbar__group--search udp-form-search-group">
        ...
        <input
            ...
            type="search"
            name="udp_s"
            class="udp-form-input udp-form-input--slim"
