...
>
	...
	<?php if ( ! empty( $menu_items ) ) :
		...
		$svg_mob_close = '<svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M26.5 13.5L13.5 26.5M13.5 13.5L26.5 26.5" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>';
		$svg_mob_chev  = '<svg width="26" height="26" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 26 26"><path d="M10 5l8 8-8 8"/></svg>';
