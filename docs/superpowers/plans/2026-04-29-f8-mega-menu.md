...
- [ ] **Step 2: Add `mega_menu_quick_links` field via jq**
...
- [ ] **Step 1: Crear `template-parts/header/mega-menu.php`**
...
- [ ] **Step 2: Modificar `header.php` para incluir el partial**
...
- [ ] **Step 1: Crear `src/js/modules/mega-menu.js`**
...
- [ ] **Step 1: Crear `src/scss/layouts/_mega-menu.scss`**
...
- [ ] **Step 2: Si no hay items en ACF, seed temporal para verificar**
